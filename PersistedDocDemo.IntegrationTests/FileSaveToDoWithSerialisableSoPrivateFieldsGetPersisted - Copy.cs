...
{
    [TestFixture]
    public class FileMemorySaveToDoWithSerialisableSoPrivateFieldsGetPersisted : RepositoryTestsBase<Todo>
    {
        private readonly Random rand;

        public FileMemorySaveToDoWithSerialisableSoPrivateFieldsGetPersisted()
        {
            rand = new Random();
        }
